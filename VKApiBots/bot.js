    ...
    return message.send(
        {
            ...
            \n3. Клиент присылает информацию Менеджеру в личные сообщения группы https://vk.com/public209040348
            \n4. Менеджер в личных сообщениях рассчитывает стоимость товара  (также клиент может перепроверить точность, рассчитав самостоятельно в этом боте)
